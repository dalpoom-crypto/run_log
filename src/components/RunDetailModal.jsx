...
const RunDetailModal = ({ run, onClose, onDelete, onEdit, currentUser, onViewUserProfile }) => {
    ...
    <div className="fixed inset-0 bg-white z-50 overflow-y-auto">
      <div className="min-h-screen flex flex-col">
        <div className="sticky top-0 bg-white border-b border-navy-100 z-10 shadow-sm">
          <div className="max-w-4xl mx-auto px-3 sm:px-4 flex items-center justify-between py-3 sm:py-4">
        ...
        {/* 다른 사람 게시물일 때 프로필 사진과 닉네임 표시 (상단바와 이미지 사이) */}
        {currentUser && run.userId && currentUser.uid !== run.userId && author && (
          <div className="bg-white border-b border-navy-100">
            <div className="max-w-4xl mx-auto px-3 sm:px-4 py-3">
              <button
                onClick={() => {
                  if (onViewUserProfile && run.userId) {
                    onViewUserProfile(run.userId);
                    onClose();
                  }
                }}
              ...
              >
                {author.photoURL ? (
                  <img
                    src={author.photoURL}
                    alt={author.nickname || author.displayName || '사용자'}
                    className="w-10 h-10 rounded-full object-cover border-2 border-navy-200"
                  />
                ) : (
                  <div className="w-10 h-10 rounded-full bg-navy-200 flex items-center justify-center border-2 border-navy-200">
                ...
                <span className="text-sm font-semibold text-navy-900">
                  {author.nickname || author.displayName || '익명'}
                </span>
              </button>
            </div>
          </div>
        ...
        <div className="bg-white max-w-4xl mx-auto pb-20 sm:pb-24 w-full">
