    ...
    <div className="min-h-screen bg-navy-50">
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-navy-200 z-50">
        <div className="max-w-4xl mx-auto px-2 sm:px-4 py-2 sm:py-3 flex justify-around items-center">
          ...
          >
            <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth={currentTab === 'home' ? '2.5' : '1.5'} viewBox="0 0 24 24">
          ...
          >
            <div className="w-10 h-10 bg-navy-700 text-white rounded-full flex items-center justify-center shadow-lg hover:bg-navy-800 transition-colors">
